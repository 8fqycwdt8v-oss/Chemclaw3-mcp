...
.DEFAULT_GOAL := help
UV ?= uv
SRC := packages/mcp_server_kit/src servers/props/src servers/chem/src servers/safety/src servers/calc/src servers/pyexec/src servers/rxnlabel/src servers/rxnpredict/src servers/thermalsafety/src
